...
.. note:: The legacy Phoenix Tuner v1 is still available for use and is pre-installed as part of the Phoenix installer.
...
.. important:: While CTR-Electronics supports both Phoenix Tuner v1 and Phoenix Tuner X, certain features such as device licensing and improved batch upgrading is only available in Phoenix Tuner X.
